...
🔗 Live Demo: [https://finance-controller-ai-production.up.railway.app/](https://finance-controller-ai-production.up.railway.app/)

## Problem

Finance teams often work across transaction files, spreadsheets, reconciliation systems, and reports. This makes it difficult to detect anomalies, prioritize risks, investigate exceptions, and maintain a clear audit trail.
